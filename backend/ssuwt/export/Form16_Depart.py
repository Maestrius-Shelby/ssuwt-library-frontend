...
def create_document(data):
    ...
    # ФИО
    author_paragraph = doc.add_paragraph(data[0]['department']['name'])
    ...
    FIO = doc.add_paragraph("(название кафедры)")
    ...
    headers = ["№\nп/п", "Наименование учебных изданий и научных трудов",
            "Форма учеб. изд. и науч. трудов", "Выходные данные", "Объем", "Авторы"]
    ...
    for i, item in enumerate(data_sorted):
        ...
        # Фильтруем авторов, исключая `depart_name`
        filtered_authors = [
            author['human']['fio']
            for author in item['authors']
            if author['human']['fio'] != zaglushka
        ]
